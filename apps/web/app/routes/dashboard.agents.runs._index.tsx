        ...
        <div className="rounded-xl border border-surface-2/50 bg-surface-1/40 backdrop-blur-sm">
          ...
          {runs.length === 0 ? (
            <EmptyState
              icon={Bot}
              title="No agent runs"
              description={filters.agent || filters.status ? "No runs match these filters." : "Agent runs will appear here once triggered."}
            />
          ) : (
                  ...
                  >
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm font-medium text-zinc-200">{run.agent_name}</span>
                        {run.trigger_type && (
                          <span className="text-xs text-zinc-600">via {run.trigger_type}</span>
                        )}
                      </div>
