...
export declare function getSupabaseClient(env: {
    ...
    Tables: {
        ...
        booking_links: {
            Row: {
                availability_rules: import("@sheetzlabs/shared").Json | null;
        ...
        chat_messages: {
            Row: {
                ...
                tokens_input: number | null;
                tokens_output: number | null;
                tool_calls: import("@sheetzlabs/shared").Json | null;
            };
            Insert: {
                content: string;
                conversation_id?: string | null;
        ...
        learning_exercises: {
            Row: {
                created_at: string | null;
                hints: import("@sheetzlabs/shared").Json | null;
                id: string;
                ...
                test_cases: import("@sheetzlabs/shared").Json | null;
                title: string;
                type: string | null;
                updated_at: string | null;
            };
        ...
        learning_messages: {
            Row: {
                content: string;
                context_files: import("@sheetzlabs/shared").Json | null;
                context_lessons: import("@sheetzlabs/shared").Json | null;
                conversation_id: string | null;
                created_at: string | null;
                id: string;
                role: string;
        ...
        quick_actions: {
            Row: {
                action_data: import("@sheetzlabs/shared").Json | null;
                action_type: string;
                category: string | null;
                created_at: string | null;
                description: string | null;
        ...
        time_block_templates: {
            Row: {
                ...
                id: string;
                name: string;
                preferred_times: import("@sheetzlabs/shared").Json | null;
            };
            Insert: {
                color?: string | null;
                created_at?: string | null;
