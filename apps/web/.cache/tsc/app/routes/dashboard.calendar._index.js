...
export default function CalendarPage() {
    const { events, accounts, reauthAccounts, tasks, subCalendars, view, weekOffset, weekStart } = useLoaderData();
