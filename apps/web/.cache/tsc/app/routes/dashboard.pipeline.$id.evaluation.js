...
export default function EvaluationDetail() {
    ...
    return (_jsxs("div", { className: "flex flex-1 flex-col", children: [_jsx(Header, { title: "Evaluation Results" }), _jsx("main", { className: "flex-1 p-6", children: _jsxs("div", { className: "mx-auto max-w-3xl space-y-6", children: [_jsxs(Link, { to: `/dashboard/ventures/pipeline/${item.id}`, className: "inline-flex items-center gap-1.5 text-sm text-zinc-500 hover:text-zinc-300", children: [_jsx(ArrowLeft, { className: "h-4 w-4" }), item.name] }), !evaluation ? (
                        /* No evaluation yet */
