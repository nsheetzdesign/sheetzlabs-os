...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; background-color: #09090b; color: #fafafa; padding: 40px 20px; margin: 0;">
  <div style="max-width: 480px; margin: 0 auto;">
    <div style="background-color: #18181b; border: 1px solid #27272a; border-radius: 12px; padding: 32px;">
      <div style="text-align: center; margin-bottom: 24px;">
        <div style="width: 48px; height: 48px; background-color: rgba(59, 130, 246, 0.2); border-radius: 50%; display: inline-flex; align-items: center; justify-content: center;">
      ...
      <div style="background-color: #27272a; border-radius: 8px; padding: 20px; margin-bottom: 24px; border: 1px solid #10b981;">
        <p style="color: #10b981; font-size: 12px; margin: 0 0 8px 0;">New time:</p>
        <h2 style="color: #fafafa; font-size: 16px; font-weight: 600; margin: 0 0 8px 0;">${data.title}</h2>
        <div style="color: #a1a1aa; font-size: 14px;">
          <p style="margin: 0 0 8px 0;">📅 ${newDate}</p>
          <p style="margin: 0 0 8px 0;">🕐 ${newTime} · ${data.duration} minutes</p>
          ${data.meetLink ? `<p style="margin: 0;">📹 <a href="${data.meetLink}" style="color: #10b981; text-decoration: none;">Join Google Meet</a></p>` : ""}
        </div>
      </div>
      ${data.meetLink ? `<a href="${data.meetLink}" style="display: block; background-color: #10b981; color: white; text-align: center; padding: 12px; border-radius: 8px; text-decoration: none; font-size: 14px; font-weight: 500;">Join Meeting</a>` : ""}
